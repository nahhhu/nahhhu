...
🚀 **Estado**: 
Abierto a nuevas oportunidades laborales como Desarrollador (Backend | Full Stack)
...
- [TechLab | API RESTful para Gestión de Inventario con Spring Boot](https://github.com/nahhhu/proyecto-Springboot):
